...
class UploadBlogContainerDesktop extends StatefulWidget {
  const UploadBlogContainerDesktop({Key? key}) : super(key: key);

  @override
  _UploadBlogContainerDesktopState createState() => _UploadBlogContainerDesktopState();
}

class _UploadBlogContainerDesktopState extends State<UploadBlogContainerDesktop> with TickerProviderStateMixin {
