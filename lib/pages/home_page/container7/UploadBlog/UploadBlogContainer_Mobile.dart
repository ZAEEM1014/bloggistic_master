...
class UploadBlogContainerMobile extends StatefulWidget {
  const UploadBlogContainerMobile({Key? key}) : super(key: key);

  @override
  _UploadBlogContainerMobileState createState() => _UploadBlogContainerMobileState();
}

class _UploadBlogContainerMobileState extends State<UploadBlogContainerMobile> with TickerProviderStateMixin {
